...
#The Credit For This Code Goes To malik farooq
...
def login():
	...
	try:
		...
		jalan(' \033[1;92m     Notice:тШЮ \033[1;93mStay Home Stay Safe Save lives Save Pakistan' )
                ...
                jalan(' \033[1;92m     Notice:тШЮ 33[1;97mPray NAMAZ five time Daily' )
		...
		try:
			...
			br.open('https://www.facebook.com/malikfarooq.khan.1')
